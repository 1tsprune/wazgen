...
var DB = [
  ...
  // === THREAT INTEL ===
  {
    id: "opencti",
    cat: "ids",
    name: "OpenCTI Threat Intel",
    prog: "opencti",
    fmt: "json",
    ex: '{"integration":"opencti","opencti.id":"12345","opencti.observable_value":"malicious.com"}',
    dc: { n: "opencti-intel", p: "json", ty: "json", pm: "opencti" },
    rl: { lv: 12, gr: "threat_intel,opencti", ds: "OpenCTI IOC detected" },
    mi: ["T1078"],
    th: "Any IOC is critical",
  },
  {
    id: "wpscan",
    cat: "web",
    ...
    rl: {
      lv: 7,
      gr: "web,wpscan,recon",
      mt: "wp-admin|wp-login|xmlrpc.php",
      ds: "WordPress scanning detected",
    },
    mi: ["T1595.002"],
    th: "14x / 30s",
  },
  {
    ...
    prog: "apache|nginx",
    fmt: "syslog",
    ex: '192.168.1.50 - - [29/Jun/2026:10:15:22 +0700] "GET /slot-gacor/judi-online HTTP/1.1" 200 1234',
    dc: {
      n: "web-access",
      p: "apache-httpd",
      pm: "GET|POST",
    ...
    rl: {
      lv: 5,
      gr: "web,judol,gambling",
      mt: "judi|slot|poker|togel|casino",
      ds: "Online gambling site access",
    },
    mi: [],
    th: "Monitor & block",
  },
